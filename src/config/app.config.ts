...
export const AppConfig = {
  ...
  quotas: {
    starter: {
      ...
      maxStorageFormatted: "500 MB",
      maxTeamSeats: 3,
      maxForecastsPerMonth: 25,
      computeNodesAllocated: 1,
      slaAvailability: "99.0% Standard Uptime",
      auditRetention: "30 Days Basic Logs",
      features: ["basic_visuals", "csv_ingestion", "weekly_digest"],
    },
    pro: {
      planTier: "PRO",
      planName: "Professional BI & Forecasting",
      priceMonthlyUsd: 299,
      ...
      computeNodesAllocated: 4,
      slaAvailability: "99.9% High Availability",
      auditRetention: "1 Year Tamper-Evident Storage",
      features: [
        "basic_visuals",
        "csv_ingestion",
        "weekly_digest",
